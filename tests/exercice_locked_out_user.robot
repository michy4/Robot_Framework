...
#   la compilation:
#       robot -d results tests/exercice_locked_out_user.robot
...
Exercice 1
    #Erreur : connexion de cet user interdite (pas vraiment smooth)
    [Documentation]  Test Connexion au site https://www.saucedemo.com/ avec le locked out user
